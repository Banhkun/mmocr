...
with open("/content/mmocr/data/icdar2015/textdet_train.json") as f:
    ann = json.load(f)
...
for data in ann["data_list"]:
    img_path = "/content/mmocr/data/icdar2015/" + data["img_path"]
    ...
    output_path = os.path.join("/content/mmocr/data/icdar2015/textdet_imgs/train", "augmented_" + file_name)
