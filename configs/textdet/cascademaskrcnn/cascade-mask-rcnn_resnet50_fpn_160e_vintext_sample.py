...
# dataset settings
vintext_textdet_train = _base_.vintext_textdet_train
vintext_textdet_test = _base_.vintext_textdet_test
vintext_textdet_train.pipeline = train_pipeline
vintext_textdet_test.pipeline = test_pipeline
...
work_dir = './work_dirs/cascade-mask-rcnn_resnet50_fpn_160e_vintext'
